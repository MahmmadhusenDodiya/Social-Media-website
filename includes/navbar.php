<div class="usernav">
    <?php
        $sql2 = "SELECT COUNT(*) AS count FROM friendship 
                 WHERE friendship.sender_id != {$_SESSION['user_id']} AND friendship.user1_id={$_SESSION['user_id']} AND friendship.friendship_status = 0";
        $query2 = mysqli_query($conn, $sql2);
        $row = mysqli_fetch_assoc($query2);
    ?>
    <ul> 
        <li>
            <a href="requests.php">Friend Requests (<?php echo $row['count'] ?>)</a></li>
